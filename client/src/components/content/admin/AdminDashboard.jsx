...
const AdminDashboard = () => {
    ...
    let a = paidAppoinments
    let b = activeAppoinments
    let c = rejectedAppoinments
    const data = {
        labels: ['Approved', 'Active', 'Cancelled'],
        datasets: [
            {
                label: '# of Votes',
                data: [a, b, c],
    ...
    return (
        <div>
            <div className="grid grid-cols-2">
                <div class="w-full max-w-md w-full grid grid-cols-2 mx-auto bg-white shadow-md rounded-md px-6 py-4 my-6">
